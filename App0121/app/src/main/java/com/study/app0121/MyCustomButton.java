...
public class MyCustomButton extends androidx.appcompat.widget.AppCompatButton {
	...
	//버튼을 포함한 모든뷰는 단독으로 존재할 수 없기때문에 반드시 어느 하나의 액티비티에서 관리되어야 한다.
	//따라서 버튼의 생성자는 이 버튼을 관리할 액티비티 클래스를 명시해 주어야 한다.
	...
	//XML에서 이 버튼을 사용하고자 할때, xml에 지정된 버튼 속성이 AttributeSet으로 넘어오게 된다.
