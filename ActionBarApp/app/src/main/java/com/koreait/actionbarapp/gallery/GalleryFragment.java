...
public class GalleryFragment extends androidx.fragment.app.Fragment {
	...
	public void getList(){
		Thread thread = new Thread(){
			public void run() {
				...
				try {
					URL url=new URL("http://192.168.219.102:7777/gallery");
	...
	public void load(String image){
		Thread thread = new Thread(){
			public void run() {
				try {
					URL url = new URL("http://192.168.219.102:7777/images/"+image);
	...
	public void getListByAsync(){
		...
		myAsync.execute("http://192.168.219.102:7777/gallery");
